  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        style: textStyle ?? TextStyle(color: textColor ?? Colors.brown, fontSize: 16 / scaleFactor, fontWeight: FontWeight.w600),
        ...
        decoration: decoration ??
            InputDecoration(
              ...
              hintStyle: hintStyle ??
                  TextStyle(
                      color: hintTextColor ?? Color(0xFF222222),
              ...
              enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(color: enabledBorderColor ?? (Colors.transparent ?? Colors.transparent)),
                borderRadius: borderRadius ?? BorderRadius.circular(100),
              ),
              focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(
                  color: focusedBorderColor ?? (Colors.transparent ?? Colors.transparent),
                ),
                borderRadius: borderRadius ?? BorderRadius.circular(100),
              ),
              errorBorder: OutlineInputBorder(
                borderSide: BorderSide(
                  color: errorBorderColor ?? (Colors.blue ?? Colors.transparent),
                ),
                borderRadius: borderRadius ?? BorderRadius.circular(100),
              ),
              focusedErrorBorder: OutlineInputBorder(
                borderSide: BorderSide(
                  color: focusedErrorBorderColor ?? (Colors.purple ?? Colors.transparent),
                ),
                borderRadius: borderRadius ?? BorderRadius.circular(100),
              ),
